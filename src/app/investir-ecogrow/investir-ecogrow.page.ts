...
@Component({
  selector: 'app-investir-ecogrow',
  templateUrl: './investir-ecogrow.page.html',
  styleUrls: ['./investir-ecogrow.page.scss'],
})
export class InvestirEcogrowPage implements OnInit {
  ...
  getVariaveis () {
    const investment = this.investmentService.investimentos[2];
  ...
  investir() {
    ...
    this.investmentService.investMoney(quantia, this.sucesso, this.lucro, 2);
  }
}
