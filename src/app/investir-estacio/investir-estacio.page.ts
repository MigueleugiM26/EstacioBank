...
@Component({
  selector: 'app-investir-estacio',
  templateUrl: './investir-estacio.page.html',
  styleUrls: ['./investir-estacio.page.scss'],
})
export class InvestirEstacioPage implements OnInit {
  ...
  getVariaveis () {
    const investment = this.investmentService.investimentos[0];
  ...
  investir() {
    ...
    this.investmentService.investMoney(quantia, this.sucesso, this.lucro, 0);
  }
}
